  ...
  <body class="skin-yellow sidebar-mini">
    <div class="wrapper">
      ...
      <header class="main-header">
        <!-- Logo -->
        <a href="/main.bt" class="logo">
          <!-- mini logo for sidebar mini 50x50 pixels -->
          <span class="logo-mini"><b>A</b>LT</span>
          <!-- logo for regular state and mobile devices -->
          <span class="logo-lg"><img src="/resources/img/logo.png" style="width:30%;"></span>
        </a>
      ...
      <aside class="main-sidebar">
        ...
        <section class="sidebar">
          ...
          <ul class="sidebar-menu">
            ...
            <li class="treeview">
              <a href="#">
                <i class="fa fa-dashboard"></i> <span>영화 게시판</span> <i class="fa fa-angle-left pull-right"></i>
              </a>
            ...
            <li class="treeview">
              ...
              <ul class="treeview-menu">
                ...
                <li><a href="/suggest/suggestList.bt?userid=${loginUser.userid}"><i class="fa fa-circle-o"></i> 분석</a></li>
                <li><a href="/suggest/recommendMovie.bt?userid=${loginUser.userid}"><i class="fa fa-circle-o"></i> 영화추천</a></li>
              </ul>
            </li>
